...
# Speaker.create(
#   name: 'RENATA CALIXTO',
#   about: "Renata Calixto é fisioterapeuta, professora, palestrante e eterna estudante. Celíaca que descobriu a saúde após embarcar no estilo de vida saudável, baseado em comida de verdade. Faz mestrado em Ciências do Exercício, é pós-graduada em Fisiologia do Exercício e Treinamento Resistido: na saúde, na doença e no envelhecimento (Faculdade de Medicina da USP), também pós-graduada em Reabilitação e Treinamento (Instituto de Ortopedia e Traumatologia do Hospital das Clínicas USP). Apaixonada por movimento, qualidade de vida e esportes, já trabalhou em clubes com diversas modalidades esportivas amadoras e também em times profissionais  de voleibol, baquetebol e futsal. Além disso é moderadora no grupo de Facebook Viva Sem Glúten e proprietária e administradora do site Vivencie Saúde.",
